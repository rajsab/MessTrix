...
<body>
	...
	<div class="row">
		...
		<div class="large-9 columns" role="content">
			...
			<hr />
			<s:form action="studentExtra">
				<sj:autocompleter id="sroll" loadMinimumCount="2" list="%{roll}"
					label="Roll" key="sroll" selectBox="true" autoFocus="true"></sj:autocompleter>
				<sj:autocompleter id="itemid" loadMinimumCount="2" list="%{itemId}"
					label="Item Id" key="itemid" selectBox="true" autoFocus="true"></sj:autocompleter>
				<s:textfield label="Quantity" key="quantity" value="1"></s:textfield>
