...
<body>
	...
	<div class="row">
		...
		<div class="large-9 columns" role="content">
			...
			<hr />
			<s:form action="updateDailyStock">
				<sj:autocompleter id="dailystock" autoFocus="true" list="id"
					label="Id" key="id" selectBox="true" />
				<s:textfield label="Quantity" key="quantity" />
				<s:textfield label="price" key="price"></s:textfield>
				<s:submit></s:submit>
		...
		<ul class="side-nav">
			...
			<li><a href='<s:action name="getItem"></s:action>'>Show item
					stock</a></li>
