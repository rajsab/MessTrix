		...
		<div class="large-9 columns" role="content">
			...
			<div class="scroll">
				<table class="pricing-table">
					...
					<thead>
						<tr>
							<th width="200" bordercolor="#FFFFFF" bgcolor="#008cba">Id</th>
							<th width="200" bordercolor="#FFFFFF" bgcolor="#008cba">Name</th>
							<th width="150" bordercolor="#FFFFFF" bgcolor="#008cba">Salary</th>
						</tr>
					</thead>

					<tbody>

						<s:iterator value="detail" var="temp">
							<tr>

								<td><s:property value="#temp.id" /></td>
								<td><s:property value="#temp.name" /></td>
								<td><s:property value="#temp.salary" /></td>
