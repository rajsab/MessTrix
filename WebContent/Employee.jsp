...
%>
<%
if(session.getAttribute("a")==null || session.getAttribute("a").equals(null) || session.getAttribute("a")=="")
{
	System.out.println("Inside jsp"+session.getAttribute("a"));
%>
