 ...
 <body>
  ...
  <div class="row">
    <div class="large-12 columns">
      ...
      <h1>MessTrics <small>Automated solutions</small></h1>
...
<s:submit></s:submit> 
    ...
    <aside class="large-3 columns">
      ...
      <h5>Categories</h5>
      <ul class="side-nav">
         <li><a href="<a href='<s:url action="getEmployee"></s:url>'>">Employee Detail</a></li>
        <li><a href="Add_employee.jsp">Add Employee</a></li>
        <li><a href='<s:url action="editEmployee"></s:url>'>Edit Employee</a></li>
       <li><a href='<s:url action="paymentHistory"></s:url>'>Payment History</a></li>
