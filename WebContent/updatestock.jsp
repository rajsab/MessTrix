...
<sx:head/>
 ...
 <s:form action="updateStock">
  <s:textfield label="Id" value="%{id}" key="id" readonly="true"/>
 <sx:datepicker displayFormat="yy-mm-dd" name="d_o_p" label="date of purchase"/>
  <s:textfield label="Quantity" key="quantity"/>
  <s:textfield label="Bill Number" key="Billno"></s:textfield>
 <s:submit></s:submit>
 </s:form>
    ...
    <aside class="large-3 columns">
      ...
      <ul class="side-nav">
        ...
        <li><a href="showitemStock.jsp">Show item stock</a></li>
