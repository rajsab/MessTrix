...
<sj:head/>
 ...
 <s:form action="messcut" theme="xhtml">
<s:textfield label="Roll" key="roll"></s:textfield>
<sj:datepicker displayFormat="mm-dd-yy" name="start" label="start date"/>
<sj:datepicker displayFormat="mm-dd-yy" name="end" label="end date"/>
