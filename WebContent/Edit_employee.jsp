...
<body>
	...
	<div class="row">
		...
		<div class="large-9 columns" role="content">
			...
			<h3>
				<s:date name="%{new java.util.Date()}" format="dd-MM-yyyy" />4
				Welcome <s:property value="#session.a" />
			</h3>
			...
			<hr />
			<s:form action="displayEmployee_detail" validate="true">
				<s:combobox list="name" headerValue="select" name="ename"
					label="Choose Employee id"></s:combobox>
				<s:submit></s:submit>
			</s:form>
		</div>
		</article>
